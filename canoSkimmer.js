class CanoSkimmer extends Cano{
  init(n,classe,team,id){
    ...
    this.x0 = (32-4*this.n) / 128; this.x1 = (98-14*this.n) / 128; this.x2 = 0;
    this.y0 = (32-12*this.n) / 128; this.y1 = (98-14*this.n) / 128; this.y2 = 0;
  ...
  shoot(){
    ...
    balas.push(new BalaSkimmer(x, y, naves[this.id].bulletSize, naves[this.id].bulletSize, naves[this.id].bulletSpd, this.rot, naves[this.id].bulletPen, naves[this.id].bulletDmg, naves[this.id].team, naves[this.id].classe, this.id, this.n));
  }
  draw(){
